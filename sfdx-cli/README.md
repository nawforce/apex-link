...
apexlink/1.3.0 darwin-x64 node-v12.16.2
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [src/commands/apexlink/check.ts](https://github.com/nawforce/apexlink/blob/v1.3.0/src/commands/apexlink/check.ts)_
<!-- commandsstop -->
