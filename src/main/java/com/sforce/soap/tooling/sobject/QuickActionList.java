 ...
 */
public class QuickActionList extends com.sforce.soap.tooling.sobject.SObject {
    ...
    /**
     * element : Layout of type {urn:sobject.tooling.soap.sforce.com}sObject
     * java type: com.sforce.soap.tooling.sobject.SObject
     */
    private boolean Layout__is_set = false;

    private com.sforce.soap.tooling.sobject.SObject Layout;

    public com.sforce.soap.tooling.sobject.SObject getLayout() {
      return Layout;
    }

    public void setLayout(com.sforce.soap.tooling.sobject.SObject Layout) {
      this.Layout = Layout;
      Layout__is_set = true;
    }
    ...
    protected void setLayout(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Layout", "urn:sobject.tooling.soap.sforce.com","Layout","urn:sobject.tooling.soap.sforce.com","sObject",0,1,true))) {
        setLayout((com.sforce.soap.tooling.sobject.SObject)__typeMapper.readObject(__in, _lookupTypeInfo("Layout", "urn:sobject.tooling.soap.sforce.com","Layout","urn:sobject.tooling.soap.sforce.com","sObject",0,1,true), com.sforce.soap.tooling.sobject.SObject.class));
      }
    }
    ...
    private void writeFieldLayout(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Layout", "urn:sobject.tooling.soap.sforce.com","Layout","urn:sobject.tooling.soap.sforce.com","sObject",0,1,true), Layout, Layout__is_set);
    }
    ...
    /**
     * element : items of type {urn:tooling.soap.sforce.com}QueryResult
     * java type: com.sforce.soap.tooling.QueryResult
     */
    private boolean items__is_set = false;

    private com.sforce.soap.tooling.QueryResult items;

    public com.sforce.soap.tooling.QueryResult getItems() {
      return items;
    }

    public void setItems(com.sforce.soap.tooling.QueryResult items) {
      this.items = items;
      items__is_set = true;
    }
    ...
    protected void setItems(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("items", "urn:sobject.tooling.soap.sforce.com","items","urn:tooling.soap.sforce.com","QueryResult",0,1,true))) {
        setItems((com.sforce.soap.tooling.QueryResult)__typeMapper.readObject(__in, _lookupTypeInfo("items", "urn:sobject.tooling.soap.sforce.com","items","urn:tooling.soap.sforce.com","QueryResult",0,1,true), com.sforce.soap.tooling.QueryResult.class));
      }
    }
    ...
    private void writeFieldItems(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("items", "urn:sobject.tooling.soap.sforce.com","items","urn:tooling.soap.sforce.com","QueryResult",0,1,true), items, items__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "QuickActionList");
