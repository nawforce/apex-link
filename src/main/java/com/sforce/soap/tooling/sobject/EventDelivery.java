 ...
 */
public class EventDelivery extends com.sforce.soap.tooling.sobject.SObject {
    ...
    /**
     * element : EventSubscription of type {urn:sobject.tooling.soap.sforce.com}EventSubscription
     * java type: com.sforce.soap.tooling.sobject.EventSubscription
     */
    private boolean EventSubscription__is_set = false;

    private com.sforce.soap.tooling.sobject.EventSubscription EventSubscription;

    public com.sforce.soap.tooling.sobject.EventSubscription getEventSubscription() {
      return EventSubscription;
    }

    public void setEventSubscription(com.sforce.soap.tooling.sobject.EventSubscription EventSubscription) {
    ...
    protected void setEventSubscription(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("EventSubscription", "urn:sobject.tooling.soap.sforce.com","EventSubscription","urn:sobject.tooling.soap.sforce.com","EventSubscription",0,1,true))) {
        setEventSubscription((com.sforce.soap.tooling.sobject.EventSubscription)__typeMapper.readObject(__in, _lookupTypeInfo("EventSubscription", "urn:sobject.tooling.soap.sforce.com","EventSubscription","urn:sobject.tooling.soap.sforce.com","EventSubscription",0,1,true), com.sforce.soap.tooling.sobject.EventSubscription.class));
      }
    }
    ...
    private void writeFieldEventSubscription(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("EventSubscription", "urn:sobject.tooling.soap.sforce.com","EventSubscription","urn:sobject.tooling.soap.sforce.com","EventSubscription",0,1,true), EventSubscription, EventSubscription__is_set);
    }

    /**
     * element : EventSubscriptionId of type {urn:tooling.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private boolean EventSubscriptionId__is_set = false;
    ...
    public void setEventSubscriptionId(java.lang.String EventSubscriptionId) {
      this.EventSubscriptionId = EventSubscriptionId;
      EventSubscriptionId__is_set = true;
    }

    protected void setEventSubscriptionId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("EventSubscriptionId", "urn:sobject.tooling.soap.sforce.com","EventSubscriptionId","urn:tooling.soap.sforce.com","ID",0,1,true))) {
        setEventSubscriptionId(__typeMapper.readString(__in, _lookupTypeInfo("EventSubscriptionId", "urn:sobject.tooling.soap.sforce.com","EventSubscriptionId","urn:tooling.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldEventSubscriptionId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("EventSubscriptionId", "urn:sobject.tooling.soap.sforce.com","EventSubscriptionId","urn:tooling.soap.sforce.com","ID",0,1,true), EventSubscriptionId, EventSubscriptionId__is_set);
    }
    ...
    /**
     * element : Metadata of type {urn:metadata.tooling.soap.sforce.com}EventDelivery
     * java type: com.sforce.soap.tooling.metadata.EventDelivery
     */
    private boolean Metadata__is_set = false;

    private com.sforce.soap.tooling.metadata.EventDelivery Metadata;

    public com.sforce.soap.tooling.metadata.EventDelivery getMetadata() {
      return Metadata;
    }

    public void setMetadata(com.sforce.soap.tooling.metadata.EventDelivery Metadata) {
    ...
    protected void setMetadata(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","EventDelivery",0,1,true))) {
        setMetadata((com.sforce.soap.tooling.metadata.EventDelivery)__typeMapper.readObject(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","EventDelivery",0,1,true), com.sforce.soap.tooling.metadata.EventDelivery.class));
      }
    }
    ...
    private void writeFieldMetadata(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","EventDelivery",0,1,true), Metadata, Metadata__is_set);
    }
    ...
    protected void setReferenceData(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ReferenceData", "urn:sobject.tooling.soap.sforce.com","ReferenceData","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setReferenceData(__typeMapper.readString(__in, _lookupTypeInfo("ReferenceData", "urn:sobject.tooling.soap.sforce.com","ReferenceData","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldReferenceData(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ReferenceData", "urn:sobject.tooling.soap.sforce.com","ReferenceData","http://www.w3.org/2001/XMLSchema","string",0,1,true), ReferenceData, ReferenceData__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "EventDelivery");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldEventSubscriptionId(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setEventSubscriptionId(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "EventSubscriptionId", EventSubscriptionId);
