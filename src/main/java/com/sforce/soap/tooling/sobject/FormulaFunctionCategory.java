 ...
 */
public class FormulaFunctionCategory extends com.sforce.soap.tooling.sobject.SObject {

    /**
     * Constructor
     */
    public FormulaFunctionCategory() {}
    ...
    /**
     * element : Functions of type {urn:tooling.soap.sforce.com}QueryResult
     * java type: com.sforce.soap.tooling.QueryResult
     */
    private boolean Functions__is_set = false;

    private com.sforce.soap.tooling.QueryResult Functions;

    public com.sforce.soap.tooling.QueryResult getFunctions() {
      return Functions;
    }

    public void setFunctions(com.sforce.soap.tooling.QueryResult Functions) {
      this.Functions = Functions;
      Functions__is_set = true;
    }

    protected void setFunctions(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Functions", "urn:sobject.tooling.soap.sforce.com","Functions","urn:tooling.soap.sforce.com","QueryResult",0,1,true))) {
        setFunctions((com.sforce.soap.tooling.QueryResult)__typeMapper.readObject(__in, _lookupTypeInfo("Functions", "urn:sobject.tooling.soap.sforce.com","Functions","urn:tooling.soap.sforce.com","QueryResult",0,1,true), com.sforce.soap.tooling.QueryResult.class));
      }
    }

    private void writeFieldFunctions(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Functions", "urn:sobject.tooling.soap.sforce.com","Functions","urn:tooling.soap.sforce.com","QueryResult",0,1,true), Functions, Functions__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "FormulaFunctionCategory");
    ...
    public String toString() {
      ...
      sb.append("[FormulaFunctionCategory ");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldFunctions(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setFunctions(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "Functions", Functions);
