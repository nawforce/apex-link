 ...
 */
public class PathAssistantSettings extends com.sforce.soap.tooling.sobject.SObject {
    ...
    /**
     * element : Metadata of type {urn:metadata.tooling.soap.sforce.com}PathAssistantSettings
     * java type: com.sforce.soap.tooling.metadata.PathAssistantSettings
     */
    private boolean Metadata__is_set = false;

    private com.sforce.soap.tooling.metadata.PathAssistantSettings Metadata;

    public com.sforce.soap.tooling.metadata.PathAssistantSettings getMetadata() {
      return Metadata;
    }

    public void setMetadata(com.sforce.soap.tooling.metadata.PathAssistantSettings Metadata) {
    ...
    protected void setMetadata(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","PathAssistantSettings",0,1,true))) {
        setMetadata((com.sforce.soap.tooling.metadata.PathAssistantSettings)__typeMapper.readObject(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","PathAssistantSettings",0,1,true), com.sforce.soap.tooling.metadata.PathAssistantSettings.class));
      }
    }
    ...
    private void writeFieldMetadata(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","PathAssistantSettings",0,1,true), Metadata, Metadata__is_set);
    }
    ...
    protected void setPathAssistantEnabled(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("PathAssistantEnabled", "urn:sobject.tooling.soap.sforce.com","PathAssistantEnabled","http://www.w3.org/2001/XMLSchema","boolean",0,1,true))) {
        setPathAssistantEnabled((java.lang.Boolean)__typeMapper.readObject(__in, _lookupTypeInfo("PathAssistantEnabled", "urn:sobject.tooling.soap.sforce.com","PathAssistantEnabled","http://www.w3.org/2001/XMLSchema","boolean",0,1,true), java.lang.Boolean.class));
      }
    }
    ...
    private void writeFieldPathAssistantEnabled(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("PathAssistantEnabled", "urn:sobject.tooling.soap.sforce.com","PathAssistantEnabled","http://www.w3.org/2001/XMLSchema","boolean",0,1,true), PathAssistantEnabled, PathAssistantEnabled__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "PathAssistantSettings");
