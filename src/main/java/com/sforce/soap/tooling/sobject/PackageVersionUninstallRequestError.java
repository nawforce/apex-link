 ...
 */
public class PackageVersionUninstallRequestError extends com.sforce.soap.tooling.sobject.SObject {

    /**
     * Constructor
     */
    public PackageVersionUninstallRequestError() {}
    ...
    /**
     * element : ParentRequest of type {urn:sobject.tooling.soap.sforce.com}SubscriberPackageVersionUninstallRequest
     * java type: com.sforce.soap.tooling.sobject.SubscriberPackageVersionUninstallRequest
     */
    private boolean ParentRequest__is_set = false;

    private com.sforce.soap.tooling.sobject.SubscriberPackageVersionUninstallRequest ParentRequest;

    public com.sforce.soap.tooling.sobject.SubscriberPackageVersionUninstallRequest getParentRequest() {
      return ParentRequest;
    }

    public void setParentRequest(com.sforce.soap.tooling.sobject.SubscriberPackageVersionUninstallRequest ParentRequest) {
      this.ParentRequest = ParentRequest;
      ParentRequest__is_set = true;
    }

    protected void setParentRequest(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ParentRequest", "urn:sobject.tooling.soap.sforce.com","ParentRequest","urn:sobject.tooling.soap.sforce.com","SubscriberPackageVersionUninstallRequest",0,1,true))) {
        setParentRequest((com.sforce.soap.tooling.sobject.SubscriberPackageVersionUninstallRequest)__typeMapper.readObject(__in, _lookupTypeInfo("ParentRequest", "urn:sobject.tooling.soap.sforce.com","ParentRequest","urn:sobject.tooling.soap.sforce.com","SubscriberPackageVersionUninstallRequest",0,1,true), com.sforce.soap.tooling.sobject.SubscriberPackageVersionUninstallRequest.class));
      }
    }

    private void writeFieldParentRequest(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ParentRequest", "urn:sobject.tooling.soap.sforce.com","ParentRequest","urn:sobject.tooling.soap.sforce.com","SubscriberPackageVersionUninstallRequest",0,1,true), ParentRequest, ParentRequest__is_set);
    }

    /**
     * element : ParentRequestId of type {urn:tooling.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private boolean ParentRequestId__is_set = false;

    private java.lang.String ParentRequestId;

    public java.lang.String getParentRequestId() {
      return ParentRequestId;
    }

    public void setParentRequestId(java.lang.String ParentRequestId) {
      this.ParentRequestId = ParentRequestId;
      ParentRequestId__is_set = true;
    }

    protected void setParentRequestId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ParentRequestId", "urn:sobject.tooling.soap.sforce.com","ParentRequestId","urn:tooling.soap.sforce.com","ID",0,1,true))) {
        setParentRequestId(__typeMapper.readString(__in, _lookupTypeInfo("ParentRequestId", "urn:sobject.tooling.soap.sforce.com","ParentRequestId","urn:tooling.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldParentRequestId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ParentRequestId", "urn:sobject.tooling.soap.sforce.com","ParentRequestId","urn:tooling.soap.sforce.com","ID",0,1,true), ParentRequestId, ParentRequestId__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "PackageVersionUninstallRequestError");
    ...
    public String toString() {
      ...
      sb.append("[PackageVersionUninstallRequestError ");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldParentRequest(__out, __typeMapper);
      writeFieldParentRequestId(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setParentRequest(__in, __typeMapper);
      setParentRequestId(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "ParentRequest", ParentRequest);
      toStringHelper(sb, "ParentRequestId", ParentRequestId);
