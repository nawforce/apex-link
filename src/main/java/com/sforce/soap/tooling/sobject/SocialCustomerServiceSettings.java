 ...
 */
public class SocialCustomerServiceSettings extends com.sforce.soap.tooling.sobject.SObject {
    ...
    /**
     * element : CaseSubjectOption of type {http://www.w3.org/2001/XMLSchema}string
     * java type: java.lang.String
     */
    private boolean CaseSubjectOption__is_set = false;

    private java.lang.String CaseSubjectOption;

    public java.lang.String getCaseSubjectOption() {
      return CaseSubjectOption;
    }

    public void setCaseSubjectOption(java.lang.String CaseSubjectOption) {
    ...
    protected void setCaseSubjectOption(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("CaseSubjectOption", "urn:sobject.tooling.soap.sforce.com","CaseSubjectOption","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setCaseSubjectOption(__typeMapper.readString(__in, _lookupTypeInfo("CaseSubjectOption", "urn:sobject.tooling.soap.sforce.com","CaseSubjectOption","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldCaseSubjectOption(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("CaseSubjectOption", "urn:sobject.tooling.soap.sforce.com","CaseSubjectOption","http://www.w3.org/2001/XMLSchema","string",0,1,true), CaseSubjectOption, CaseSubjectOption__is_set);
    }
    ...
    /**
     * element : Metadata of type {urn:metadata.tooling.soap.sforce.com}SocialCustomerServiceSettings
     * java type: com.sforce.soap.tooling.metadata.SocialCustomerServiceSettings
     */
    private boolean Metadata__is_set = false;

    private com.sforce.soap.tooling.metadata.SocialCustomerServiceSettings Metadata;

    public com.sforce.soap.tooling.metadata.SocialCustomerServiceSettings getMetadata() {
      return Metadata;
    }

    public void setMetadata(com.sforce.soap.tooling.metadata.SocialCustomerServiceSettings Metadata) {
    ...
    protected void setMetadata(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","SocialCustomerServiceSettings",0,1,true))) {
        setMetadata((com.sforce.soap.tooling.metadata.SocialCustomerServiceSettings)__typeMapper.readObject(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","SocialCustomerServiceSettings",0,1,true), com.sforce.soap.tooling.metadata.SocialCustomerServiceSettings.class));
      }
    }
    ...
    private void writeFieldMetadata(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","SocialCustomerServiceSettings",0,1,true), Metadata, Metadata__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "SocialCustomerServiceSettings");
