 ...
 */
public class WorkflowRuleMember extends com.sforce.soap.tooling.sobject.SObject {

    /**
     * Constructor
     */
    public WorkflowRuleMember() {}
    ...
    /**
     * element : ContentEntity of type {urn:sobject.tooling.soap.sforce.com}WorkflowRule
     * java type: com.sforce.soap.tooling.sobject.WorkflowRule
     */
    private boolean ContentEntity__is_set = false;

    private com.sforce.soap.tooling.sobject.WorkflowRule ContentEntity;

    public com.sforce.soap.tooling.sobject.WorkflowRule getContentEntity() {
      return ContentEntity;
    }

    public void setContentEntity(com.sforce.soap.tooling.sobject.WorkflowRule ContentEntity) {
    ...
    protected void setContentEntity(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ContentEntity", "urn:sobject.tooling.soap.sforce.com","ContentEntity","urn:sobject.tooling.soap.sforce.com","WorkflowRule",0,1,true))) {
        setContentEntity((com.sforce.soap.tooling.sobject.WorkflowRule)__typeMapper.readObject(__in, _lookupTypeInfo("ContentEntity", "urn:sobject.tooling.soap.sforce.com","ContentEntity","urn:sobject.tooling.soap.sforce.com","WorkflowRule",0,1,true), com.sforce.soap.tooling.sobject.WorkflowRule.class));
      }
    }
    ...
    private void writeFieldContentEntity(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ContentEntity", "urn:sobject.tooling.soap.sforce.com","ContentEntity","urn:sobject.tooling.soap.sforce.com","WorkflowRule",0,1,true), ContentEntity, ContentEntity__is_set);
    }
    ...
    /**
     * element : Metadata of type {urn:metadata.tooling.soap.sforce.com}WorkflowRule
     * java type: com.sforce.soap.tooling.metadata.WorkflowRule
     */
    private boolean Metadata__is_set = false;

    private com.sforce.soap.tooling.metadata.WorkflowRule Metadata;

    public com.sforce.soap.tooling.metadata.WorkflowRule getMetadata() {
      return Metadata;
    }

    public void setMetadata(com.sforce.soap.tooling.metadata.WorkflowRule Metadata) {
    ...
    protected void setMetadata(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","WorkflowRule",0,1,true))) {
        setMetadata((com.sforce.soap.tooling.metadata.WorkflowRule)__typeMapper.readObject(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","WorkflowRule",0,1,true), com.sforce.soap.tooling.metadata.WorkflowRule.class));
      }
    }
    ...
    private void writeFieldMetadata(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","WorkflowRule",0,1,true), Metadata, Metadata__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "WorkflowRuleMember");
