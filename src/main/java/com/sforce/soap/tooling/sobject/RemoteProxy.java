 ...
 */
public class RemoteProxy extends com.sforce.soap.tooling.sobject.SObject {
    ...
    protected void setEndpointUrl(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("EndpointUrl", "urn:sobject.tooling.soap.sforce.com","EndpointUrl","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setEndpointUrl(__typeMapper.readString(__in, _lookupTypeInfo("EndpointUrl", "urn:sobject.tooling.soap.sforce.com","EndpointUrl","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldEndpointUrl(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("EndpointUrl", "urn:sobject.tooling.soap.sforce.com","EndpointUrl","http://www.w3.org/2001/XMLSchema","string",0,1,true), EndpointUrl, EndpointUrl__is_set);
    }
    ...
    /**
     * element : Metadata of type {urn:metadata.tooling.soap.sforce.com}RemoteSiteSetting
     * java type: com.sforce.soap.tooling.metadata.RemoteSiteSetting
     */
    private boolean Metadata__is_set = false;

    private com.sforce.soap.tooling.metadata.RemoteSiteSetting Metadata;

    public com.sforce.soap.tooling.metadata.RemoteSiteSetting getMetadata() {
      return Metadata;
    }

    public void setMetadata(com.sforce.soap.tooling.metadata.RemoteSiteSetting Metadata) {
    ...
    protected void setMetadata(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","RemoteSiteSetting",0,1,true))) {
        setMetadata((com.sforce.soap.tooling.metadata.RemoteSiteSetting)__typeMapper.readObject(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","RemoteSiteSetting",0,1,true), com.sforce.soap.tooling.metadata.RemoteSiteSetting.class));
      }
    }
    ...
    private void writeFieldMetadata(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","RemoteSiteSetting",0,1,true), Metadata, Metadata__is_set);
    }
    ...
    /**
     * element : ProtocolMismatch of type {http://www.w3.org/2001/XMLSchema}boolean
     * java type: java.lang.Boolean
     */
    private boolean ProtocolMismatch__is_set = false;

    private java.lang.Boolean ProtocolMismatch;

    public java.lang.Boolean getProtocolMismatch() {
      return ProtocolMismatch;
    }

    public void setProtocolMismatch(java.lang.Boolean ProtocolMismatch) {
      this.ProtocolMismatch = ProtocolMismatch;
      ProtocolMismatch__is_set = true;
    }

    protected void setProtocolMismatch(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ProtocolMismatch", "urn:sobject.tooling.soap.sforce.com","ProtocolMismatch","http://www.w3.org/2001/XMLSchema","boolean",0,1,true))) {
        setProtocolMismatch((java.lang.Boolean)__typeMapper.readObject(__in, _lookupTypeInfo("ProtocolMismatch", "urn:sobject.tooling.soap.sforce.com","ProtocolMismatch","http://www.w3.org/2001/XMLSchema","boolean",0,1,true), java.lang.Boolean.class));
      }
    }

    private void writeFieldProtocolMismatch(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ProtocolMismatch", "urn:sobject.tooling.soap.sforce.com","ProtocolMismatch","http://www.w3.org/2001/XMLSchema","boolean",0,1,true), ProtocolMismatch, ProtocolMismatch__is_set);
    }

    /**
     * element : SiteName of type {http://www.w3.org/2001/XMLSchema}string
     * java type: java.lang.String
     */
    private boolean SiteName__is_set = false;
    ...
    public void setSiteName(java.lang.String SiteName) {
      ...
      SiteName__is_set = true;
    }

    protected void setSiteName(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("SiteName", "urn:sobject.tooling.soap.sforce.com","SiteName","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setSiteName(__typeMapper.readString(__in, _lookupTypeInfo("SiteName", "urn:sobject.tooling.soap.sforce.com","SiteName","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldSiteName(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("SiteName", "urn:sobject.tooling.soap.sforce.com","SiteName","http://www.w3.org/2001/XMLSchema","string",0,1,true), SiteName, SiteName__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "RemoteProxy");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldProtocolMismatch(__out, __typeMapper);
      writeFieldSiteName(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setProtocolMismatch(__in, __typeMapper);
      setSiteName(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "ProtocolMismatch", ProtocolMismatch);
      toStringHelper(sb, "SiteName", SiteName);
