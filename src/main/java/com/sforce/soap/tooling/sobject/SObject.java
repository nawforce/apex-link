...
public class SObject implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setFieldsToNull(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("fieldsToNull", "urn:sobject.tooling.soap.sforce.com","fieldsToNull","http://www.w3.org/2001/XMLSchema","string",0,-1,true))) {
        setFieldsToNull((java.lang.String[])__typeMapper.readObject(__in, _lookupTypeInfo("fieldsToNull", "urn:sobject.tooling.soap.sforce.com","fieldsToNull","http://www.w3.org/2001/XMLSchema","string",0,-1,true), java.lang.String[].class));
      }
    }
    ...
    private void writeFieldFieldsToNull(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("fieldsToNull", "urn:sobject.tooling.soap.sforce.com","fieldsToNull","http://www.w3.org/2001/XMLSchema","string",0,-1,true), fieldsToNull, fieldsToNull__is_set);
    }
    ...
    protected void setId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("Id", "urn:sobject.tooling.soap.sforce.com","Id","urn:tooling.soap.sforce.com","ID",1,1,true))) {
        setId(__typeMapper.readString(__in, _lookupTypeInfo("Id", "urn:sobject.tooling.soap.sforce.com","Id","urn:tooling.soap.sforce.com","ID",1,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Id", "urn:sobject.tooling.soap.sforce.com","Id","urn:tooling.soap.sforce.com","ID",1,1,true), Id, Id__is_set);
    }
