 ...
 */
public class Index extends com.sforce.soap.tooling.sobject.SObject {
    ...
    /**
     * element : IndexFields of type {urn:tooling.soap.sforce.com}QueryResult
     * java type: com.sforce.soap.tooling.QueryResult
     */
    private boolean IndexFields__is_set = false;

    private com.sforce.soap.tooling.QueryResult IndexFields;

    public com.sforce.soap.tooling.QueryResult getIndexFields() {
      return IndexFields;
    }

    public void setIndexFields(com.sforce.soap.tooling.QueryResult IndexFields) {
      this.IndexFields = IndexFields;
      IndexFields__is_set = true;
    }

    protected void setIndexFields(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("IndexFields", "urn:sobject.tooling.soap.sforce.com","IndexFields","urn:tooling.soap.sforce.com","QueryResult",0,1,true))) {
        setIndexFields((com.sforce.soap.tooling.QueryResult)__typeMapper.readObject(__in, _lookupTypeInfo("IndexFields", "urn:sobject.tooling.soap.sforce.com","IndexFields","urn:tooling.soap.sforce.com","QueryResult",0,1,true), com.sforce.soap.tooling.QueryResult.class));
      }
    }

    private void writeFieldIndexFields(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("IndexFields", "urn:sobject.tooling.soap.sforce.com","IndexFields","urn:tooling.soap.sforce.com","QueryResult",0,1,true), IndexFields, IndexFields__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "Index");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldIndexFields(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setIndexFields(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "IndexFields", IndexFields);
