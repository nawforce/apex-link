 ...
 */
public class LightningComponentResource extends com.sforce.soap.tooling.sobject.SObject {

    /**
     * Constructor
     */
    public LightningComponentResource() {}
    ...
    protected void setFilePath(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("FilePath", "urn:sobject.tooling.soap.sforce.com","FilePath","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setFilePath(__typeMapper.readString(__in, _lookupTypeInfo("FilePath", "urn:sobject.tooling.soap.sforce.com","FilePath","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldFilePath(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("FilePath", "urn:sobject.tooling.soap.sforce.com","FilePath","http://www.w3.org/2001/XMLSchema","string",0,1,true), FilePath, FilePath__is_set);
    }
    ...
    /**
     * element : LightningComponentBundle of type {urn:sobject.tooling.soap.sforce.com}LightningComponentBundle
     * java type: com.sforce.soap.tooling.sobject.LightningComponentBundle
     */
    private boolean LightningComponentBundle__is_set = false;

    private com.sforce.soap.tooling.sobject.LightningComponentBundle LightningComponentBundle;

    public com.sforce.soap.tooling.sobject.LightningComponentBundle getLightningComponentBundle() {
      return LightningComponentBundle;
    }

    public void setLightningComponentBundle(com.sforce.soap.tooling.sobject.LightningComponentBundle LightningComponentBundle) {
      this.LightningComponentBundle = LightningComponentBundle;
      LightningComponentBundle__is_set = true;
    }

    protected void setLightningComponentBundle(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("LightningComponentBundle", "urn:sobject.tooling.soap.sforce.com","LightningComponentBundle","urn:sobject.tooling.soap.sforce.com","LightningComponentBundle",0,1,true))) {
        setLightningComponentBundle((com.sforce.soap.tooling.sobject.LightningComponentBundle)__typeMapper.readObject(__in, _lookupTypeInfo("LightningComponentBundle", "urn:sobject.tooling.soap.sforce.com","LightningComponentBundle","urn:sobject.tooling.soap.sforce.com","LightningComponentBundle",0,1,true), com.sforce.soap.tooling.sobject.LightningComponentBundle.class));
      }
    }

    private void writeFieldLightningComponentBundle(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("LightningComponentBundle", "urn:sobject.tooling.soap.sforce.com","LightningComponentBundle","urn:sobject.tooling.soap.sforce.com","LightningComponentBundle",0,1,true), LightningComponentBundle, LightningComponentBundle__is_set);
    }

    /**
     * element : LightningComponentBundleId of type {urn:tooling.soap.sforce.com}ID
     * java type: java.lang.String
     */
    ...
    protected void setLightningComponentBundleId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("LightningComponentBundleId", "urn:sobject.tooling.soap.sforce.com","LightningComponentBundleId","urn:tooling.soap.sforce.com","ID",0,1,true))) {
        setLightningComponentBundleId(__typeMapper.readString(__in, _lookupTypeInfo("LightningComponentBundleId", "urn:sobject.tooling.soap.sforce.com","LightningComponentBundleId","urn:tooling.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldLightningComponentBundleId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("LightningComponentBundleId", "urn:sobject.tooling.soap.sforce.com","LightningComponentBundleId","urn:tooling.soap.sforce.com","ID",0,1,true), LightningComponentBundleId, LightningComponentBundleId__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "LightningComponentResource");
    ...
    public String toString() {
      ...
      sb.append("[LightningComponentResource ");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldLightningComponentBundle(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setLightningComponentBundle(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "LightningComponentBundle", LightningComponentBundle);
