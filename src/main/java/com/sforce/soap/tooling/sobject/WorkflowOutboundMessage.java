 ...
 */
public class WorkflowOutboundMessage extends com.sforce.soap.tooling.sobject.SObject {
    ...
    /**
     * element : IntegrationUserId of type {urn:tooling.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private boolean IntegrationUserId__is_set = false;

    private java.lang.String IntegrationUserId;

    public java.lang.String getIntegrationUserId() {
      return IntegrationUserId;
    }

    public void setIntegrationUserId(java.lang.String IntegrationUserId) {
      this.IntegrationUserId = IntegrationUserId;
      IntegrationUserId__is_set = true;
    }

    protected void setIntegrationUserId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("IntegrationUserId", "urn:sobject.tooling.soap.sforce.com","IntegrationUserId","urn:tooling.soap.sforce.com","ID",0,1,true))) {
        setIntegrationUserId(__typeMapper.readString(__in, _lookupTypeInfo("IntegrationUserId", "urn:sobject.tooling.soap.sforce.com","IntegrationUserId","urn:tooling.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldIntegrationUserId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("IntegrationUserId", "urn:sobject.tooling.soap.sforce.com","IntegrationUserId","urn:tooling.soap.sforce.com","ID",0,1,true), IntegrationUserId, IntegrationUserId__is_set);
    }
    ...
    /**
     * element : Metadata of type {urn:metadata.tooling.soap.sforce.com}WorkflowOutboundMessage
     * java type: com.sforce.soap.tooling.metadata.WorkflowOutboundMessage
     */
    private boolean Metadata__is_set = false;

    private com.sforce.soap.tooling.metadata.WorkflowOutboundMessage Metadata;

    public com.sforce.soap.tooling.metadata.WorkflowOutboundMessage getMetadata() {
      return Metadata;
    }

    public void setMetadata(com.sforce.soap.tooling.metadata.WorkflowOutboundMessage Metadata) {
    ...
    protected void setMetadata(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","WorkflowOutboundMessage",0,1,true))) {
        setMetadata((com.sforce.soap.tooling.metadata.WorkflowOutboundMessage)__typeMapper.readObject(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","WorkflowOutboundMessage",0,1,true), com.sforce.soap.tooling.metadata.WorkflowOutboundMessage.class));
      }
    }
    ...
    private void writeFieldMetadata(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","WorkflowOutboundMessage",0,1,true), Metadata, Metadata__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "WorkflowOutboundMessage");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldIntegrationUserId(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setIntegrationUserId(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "IntegrationUserId", IntegrationUserId);
