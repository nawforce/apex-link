 ...
 */
public class SubscriberPackageVersionUninstallRequest extends com.sforce.soap.tooling.sobject.SObject {

    /**
     * Constructor
     */
    public SubscriberPackageVersionUninstallRequest() {}
    ...
    /**
     * element : SubscriberPackageVersionUninstallRequestErrors of type {urn:tooling.soap.sforce.com}QueryResult
     * java type: com.sforce.soap.tooling.QueryResult
     */
    private boolean SubscriberPackageVersionUninstallRequestErrors__is_set = false;

    private com.sforce.soap.tooling.QueryResult SubscriberPackageVersionUninstallRequestErrors;

    public com.sforce.soap.tooling.QueryResult getSubscriberPackageVersionUninstallRequestErrors() {
      return SubscriberPackageVersionUninstallRequestErrors;
    }

    public void setSubscriberPackageVersionUninstallRequestErrors(com.sforce.soap.tooling.QueryResult SubscriberPackageVersionUninstallRequestErrors) {
      this.SubscriberPackageVersionUninstallRequestErrors = SubscriberPackageVersionUninstallRequestErrors;
      SubscriberPackageVersionUninstallRequestErrors__is_set = true;
    }

    protected void setSubscriberPackageVersionUninstallRequestErrors(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("SubscriberPackageVersionUninstallRequestErrors", "urn:sobject.tooling.soap.sforce.com","SubscriberPackageVersionUninstallRequestErrors","urn:tooling.soap.sforce.com","QueryResult",0,1,true))) {
        setSubscriberPackageVersionUninstallRequestErrors((com.sforce.soap.tooling.QueryResult)__typeMapper.readObject(__in, _lookupTypeInfo("SubscriberPackageVersionUninstallRequestErrors", "urn:sobject.tooling.soap.sforce.com","SubscriberPackageVersionUninstallRequestErrors","urn:tooling.soap.sforce.com","QueryResult",0,1,true), com.sforce.soap.tooling.QueryResult.class));
      }
    }

    private void writeFieldSubscriberPackageVersionUninstallRequestErrors(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("SubscriberPackageVersionUninstallRequestErrors", "urn:sobject.tooling.soap.sforce.com","SubscriberPackageVersionUninstallRequestErrors","urn:tooling.soap.sforce.com","QueryResult",0,1,true), SubscriberPackageVersionUninstallRequestErrors, SubscriberPackageVersionUninstallRequestErrors__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "SubscriberPackageVersionUninstallRequest");
    ...
    public String toString() {
      ...
      sb.append("[SubscriberPackageVersionUninstallRequest ");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldSubscriberPackageVersionUninstallRequestErrors(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setSubscriberPackageVersionUninstallRequestErrors(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "SubscriberPackageVersionUninstallRequestErrors", SubscriberPackageVersionUninstallRequestErrors);
