 ...
 */
public class WorkflowTaskMember extends com.sforce.soap.tooling.sobject.SObject {

    /**
     * Constructor
     */
    public WorkflowTaskMember() {}
    ...
    /**
     * element : ContentEntity of type {urn:sobject.tooling.soap.sforce.com}WorkflowTask
     * java type: com.sforce.soap.tooling.sobject.WorkflowTask
     */
    private boolean ContentEntity__is_set = false;

    private com.sforce.soap.tooling.sobject.WorkflowTask ContentEntity;

    public com.sforce.soap.tooling.sobject.WorkflowTask getContentEntity() {
      return ContentEntity;
    }

    public void setContentEntity(com.sforce.soap.tooling.sobject.WorkflowTask ContentEntity) {
    ...
    protected void setContentEntity(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ContentEntity", "urn:sobject.tooling.soap.sforce.com","ContentEntity","urn:sobject.tooling.soap.sforce.com","WorkflowTask",0,1,true))) {
        setContentEntity((com.sforce.soap.tooling.sobject.WorkflowTask)__typeMapper.readObject(__in, _lookupTypeInfo("ContentEntity", "urn:sobject.tooling.soap.sforce.com","ContentEntity","urn:sobject.tooling.soap.sforce.com","WorkflowTask",0,1,true), com.sforce.soap.tooling.sobject.WorkflowTask.class));
      }
    }
    ...
    private void writeFieldContentEntity(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ContentEntity", "urn:sobject.tooling.soap.sforce.com","ContentEntity","urn:sobject.tooling.soap.sforce.com","WorkflowTask",0,1,true), ContentEntity, ContentEntity__is_set);
    }
    ...
    /**
     * element : Metadata of type {urn:metadata.tooling.soap.sforce.com}WorkflowTask
     * java type: com.sforce.soap.tooling.metadata.WorkflowTask
     */
    private boolean Metadata__is_set = false;

    private com.sforce.soap.tooling.metadata.WorkflowTask Metadata;

    public com.sforce.soap.tooling.metadata.WorkflowTask getMetadata() {
      return Metadata;
    }

    public void setMetadata(com.sforce.soap.tooling.metadata.WorkflowTask Metadata) {
    ...
    protected void setMetadata(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","WorkflowTask",0,1,true))) {
        setMetadata((com.sforce.soap.tooling.metadata.WorkflowTask)__typeMapper.readObject(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","WorkflowTask",0,1,true), com.sforce.soap.tooling.metadata.WorkflowTask.class));
      }
    }
    ...
    private void writeFieldMetadata(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","WorkflowTask",0,1,true), Metadata, Metadata__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "WorkflowTaskMember");
