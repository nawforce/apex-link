 ...
 */
public class GlobalValueSet extends com.sforce.soap.tooling.sobject.SObject {
    ...
    /**
     * element : Metadata of type {urn:metadata.tooling.soap.sforce.com}GlobalValueSet
     * java type: com.sforce.soap.tooling.metadata.GlobalValueSet
     */
    private boolean Metadata__is_set = false;

    private com.sforce.soap.tooling.metadata.GlobalValueSet Metadata;

    public com.sforce.soap.tooling.metadata.GlobalValueSet getMetadata() {
      return Metadata;
    }

    public void setMetadata(com.sforce.soap.tooling.metadata.GlobalValueSet Metadata) {
    ...
    protected void setMetadata(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","GlobalValueSet",0,1,true))) {
        setMetadata((com.sforce.soap.tooling.metadata.GlobalValueSet)__typeMapper.readObject(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","GlobalValueSet",0,1,true), com.sforce.soap.tooling.metadata.GlobalValueSet.class));
      }
    }
    ...
    private void writeFieldMetadata(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","GlobalValueSet",0,1,true), Metadata, Metadata__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "GlobalValueSet");
