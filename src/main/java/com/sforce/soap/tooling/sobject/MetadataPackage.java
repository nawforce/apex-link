 ...
 */
public class MetadataPackage extends com.sforce.soap.tooling.sobject.SObject {
    ...
    /**
     * element : MetadataPackageVersions of type {urn:tooling.soap.sforce.com}QueryResult
     * java type: com.sforce.soap.tooling.QueryResult
     */
    private boolean MetadataPackageVersions__is_set = false;

    private com.sforce.soap.tooling.QueryResult MetadataPackageVersions;

    public com.sforce.soap.tooling.QueryResult getMetadataPackageVersions() {
      return MetadataPackageVersions;
    }

    public void setMetadataPackageVersions(com.sforce.soap.tooling.QueryResult MetadataPackageVersions) {
      this.MetadataPackageVersions = MetadataPackageVersions;
      MetadataPackageVersions__is_set = true;
    }

    protected void setMetadataPackageVersions(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("MetadataPackageVersions", "urn:sobject.tooling.soap.sforce.com","MetadataPackageVersions","urn:tooling.soap.sforce.com","QueryResult",0,1,true))) {
        setMetadataPackageVersions((com.sforce.soap.tooling.QueryResult)__typeMapper.readObject(__in, _lookupTypeInfo("MetadataPackageVersions", "urn:sobject.tooling.soap.sforce.com","MetadataPackageVersions","urn:tooling.soap.sforce.com","QueryResult",0,1,true), com.sforce.soap.tooling.QueryResult.class));
      }
    }

    private void writeFieldMetadataPackageVersions(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("MetadataPackageVersions", "urn:sobject.tooling.soap.sforce.com","MetadataPackageVersions","urn:tooling.soap.sforce.com","QueryResult",0,1,true), MetadataPackageVersions, MetadataPackageVersions__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "MetadataPackage");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldMetadataPackageVersions(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      setMetadataPackageVersions(__in, __typeMapper);
      setName(__in, __typeMapper);
      setNamespacePrefix(__in, __typeMapper);
    }

    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "MetadataPackageVersions", MetadataPackageVersions);
