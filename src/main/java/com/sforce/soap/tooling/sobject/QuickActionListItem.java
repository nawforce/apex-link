 ...
 */
public class QuickActionListItem extends com.sforce.soap.tooling.sobject.SObject {
    ...
    protected void setQuickActionDefinition(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("QuickActionDefinition", "urn:sobject.tooling.soap.sforce.com","QuickActionDefinition","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setQuickActionDefinition(__typeMapper.readString(__in, _lookupTypeInfo("QuickActionDefinition", "urn:sobject.tooling.soap.sforce.com","QuickActionDefinition","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldQuickActionDefinition(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("QuickActionDefinition", "urn:sobject.tooling.soap.sforce.com","QuickActionDefinition","http://www.w3.org/2001/XMLSchema","string",0,1,true), QuickActionDefinition, QuickActionDefinition__is_set);
    }

    /**
     * element : QuickActionList of type {urn:sobject.tooling.soap.sforce.com}QuickActionList
     * java type: com.sforce.soap.tooling.sobject.QuickActionList
     */
    private boolean QuickActionList__is_set = false;

    private com.sforce.soap.tooling.sobject.QuickActionList QuickActionList;

    public com.sforce.soap.tooling.sobject.QuickActionList getQuickActionList() {
      return QuickActionList;
    }

    public void setQuickActionList(com.sforce.soap.tooling.sobject.QuickActionList QuickActionList) {
    ...
    protected void setQuickActionList(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("QuickActionList", "urn:sobject.tooling.soap.sforce.com","QuickActionList","urn:sobject.tooling.soap.sforce.com","QuickActionList",0,1,true))) {
        setQuickActionList((com.sforce.soap.tooling.sobject.QuickActionList)__typeMapper.readObject(__in, _lookupTypeInfo("QuickActionList", "urn:sobject.tooling.soap.sforce.com","QuickActionList","urn:sobject.tooling.soap.sforce.com","QuickActionList",0,1,true), com.sforce.soap.tooling.sobject.QuickActionList.class));
      }
    }
    ...
    private void writeFieldQuickActionList(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("QuickActionList", "urn:sobject.tooling.soap.sforce.com","QuickActionList","urn:sobject.tooling.soap.sforce.com","QuickActionList",0,1,true), QuickActionList, QuickActionList__is_set);
    }

    /**
     * element : QuickActionListId of type {urn:tooling.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private boolean QuickActionListId__is_set = false;

    private java.lang.String QuickActionListId;

    public java.lang.String getQuickActionListId() {
      return QuickActionListId;
    }

    public void setQuickActionListId(java.lang.String QuickActionListId) {
      this.QuickActionListId = QuickActionListId;
      QuickActionListId__is_set = true;
    }

    protected void setQuickActionListId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("QuickActionListId", "urn:sobject.tooling.soap.sforce.com","QuickActionListId","urn:tooling.soap.sforce.com","ID",0,1,true))) {
        setQuickActionListId(__typeMapper.readString(__in, _lookupTypeInfo("QuickActionListId", "urn:sobject.tooling.soap.sforce.com","QuickActionListId","urn:tooling.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldQuickActionListId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("QuickActionListId", "urn:sobject.tooling.soap.sforce.com","QuickActionListId","urn:tooling.soap.sforce.com","ID",0,1,true), QuickActionListId, QuickActionListId__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "QuickActionListItem");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldQuickActionListId(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setQuickActionListId(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "QuickActionListId", QuickActionListId);
