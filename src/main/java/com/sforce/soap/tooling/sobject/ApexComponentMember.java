 ...
 */
public class ApexComponentMember extends com.sforce.soap.tooling.sobject.SObject {
    ...
    /**
     * element : ContentEntity of type {urn:sobject.tooling.soap.sforce.com}ApexComponent
     * java type: com.sforce.soap.tooling.sobject.ApexComponent
     */
    private boolean ContentEntity__is_set = false;

    private com.sforce.soap.tooling.sobject.ApexComponent ContentEntity;

    public com.sforce.soap.tooling.sobject.ApexComponent getContentEntity() {
      return ContentEntity;
    }

    public void setContentEntity(com.sforce.soap.tooling.sobject.ApexComponent ContentEntity) {
    ...
    protected void setContentEntity(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("ContentEntity", "urn:sobject.tooling.soap.sforce.com","ContentEntity","urn:sobject.tooling.soap.sforce.com","ApexComponent",0,1,true))) {
        setContentEntity((com.sforce.soap.tooling.sobject.ApexComponent)__typeMapper.readObject(__in, _lookupTypeInfo("ContentEntity", "urn:sobject.tooling.soap.sforce.com","ContentEntity","urn:sobject.tooling.soap.sforce.com","ApexComponent",0,1,true), com.sforce.soap.tooling.sobject.ApexComponent.class));
      }
    }
    ...
    private void writeFieldContentEntity(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("ContentEntity", "urn:sobject.tooling.soap.sforce.com","ContentEntity","urn:sobject.tooling.soap.sforce.com","ApexComponent",0,1,true), ContentEntity, ContentEntity__is_set);
    }
    ...
    /**
     * element : Metadata of type {urn:metadata.tooling.soap.sforce.com}ApexComponent
     * java type: com.sforce.soap.tooling.metadata.ApexComponent
     */
    ...
    public void setMetadata(com.sforce.soap.tooling.metadata.ApexComponent Metadata) {
    ...
    protected void setMetadata(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","ApexComponent",0,1,true))) {
        setMetadata((com.sforce.soap.tooling.metadata.ApexComponent)__typeMapper.readObject(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","ApexComponent",0,1,true), com.sforce.soap.tooling.metadata.ApexComponent.class));
      }
    }
    ...
    private void writeFieldMetadata(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","ApexComponent",0,1,true), Metadata, Metadata__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "ApexComponentMember");
