 ...
 */
public class FieldMapping extends com.sforce.soap.tooling.sobject.SObject {
    ...
    /**
     * element : FieldMappingClient of type {urn:sobject.tooling.soap.sforce.com}CleanRule
     * java type: com.sforce.soap.tooling.sobject.CleanRule
     */
    private boolean FieldMappingClient__is_set = false;

    private com.sforce.soap.tooling.sobject.CleanRule FieldMappingClient;

    public com.sforce.soap.tooling.sobject.CleanRule getFieldMappingClient() {
      return FieldMappingClient;
    }

    public void setFieldMappingClient(com.sforce.soap.tooling.sobject.CleanRule FieldMappingClient) {
      this.FieldMappingClient = FieldMappingClient;
      FieldMappingClient__is_set = true;
    }

    protected void setFieldMappingClient(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("FieldMappingClient", "urn:sobject.tooling.soap.sforce.com","FieldMappingClient","urn:sobject.tooling.soap.sforce.com","CleanRule",0,1,true))) {
        setFieldMappingClient((com.sforce.soap.tooling.sobject.CleanRule)__typeMapper.readObject(__in, _lookupTypeInfo("FieldMappingClient", "urn:sobject.tooling.soap.sforce.com","FieldMappingClient","urn:sobject.tooling.soap.sforce.com","CleanRule",0,1,true), com.sforce.soap.tooling.sobject.CleanRule.class));
      }
    }

    private void writeFieldFieldMappingClient(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("FieldMappingClient", "urn:sobject.tooling.soap.sforce.com","FieldMappingClient","urn:sobject.tooling.soap.sforce.com","CleanRule",0,1,true), FieldMappingClient, FieldMappingClient__is_set);
    }

    /**
     * element : FieldMappingClientId of type {urn:tooling.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private boolean FieldMappingClientId__is_set = false;

    private java.lang.String FieldMappingClientId;

    public java.lang.String getFieldMappingClientId() {
      return FieldMappingClientId;
    }

    public void setFieldMappingClientId(java.lang.String FieldMappingClientId) {
      this.FieldMappingClientId = FieldMappingClientId;
      FieldMappingClientId__is_set = true;
    }

    protected void setFieldMappingClientId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("FieldMappingClientId", "urn:sobject.tooling.soap.sforce.com","FieldMappingClientId","urn:tooling.soap.sforce.com","ID",0,1,true))) {
        setFieldMappingClientId(__typeMapper.readString(__in, _lookupTypeInfo("FieldMappingClientId", "urn:sobject.tooling.soap.sforce.com","FieldMappingClientId","urn:tooling.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldFieldMappingClientId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("FieldMappingClientId", "urn:sobject.tooling.soap.sforce.com","FieldMappingClientId","urn:tooling.soap.sforce.com","ID",0,1,true), FieldMappingClientId, FieldMappingClientId__is_set);
    }

    /**
     * element : FieldMappings of type {urn:tooling.soap.sforce.com}QueryResult
     * java type: com.sforce.soap.tooling.QueryResult
     */
    private boolean FieldMappings__is_set = false;

    private com.sforce.soap.tooling.QueryResult FieldMappings;

    public com.sforce.soap.tooling.QueryResult getFieldMappings() {
      return FieldMappings;
    }

    public void setFieldMappings(com.sforce.soap.tooling.QueryResult FieldMappings) {
    ...
    protected void setFieldMappings(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("FieldMappings", "urn:sobject.tooling.soap.sforce.com","FieldMappings","urn:tooling.soap.sforce.com","QueryResult",0,1,true))) {
        setFieldMappings((com.sforce.soap.tooling.QueryResult)__typeMapper.readObject(__in, _lookupTypeInfo("FieldMappings", "urn:sobject.tooling.soap.sforce.com","FieldMappings","urn:tooling.soap.sforce.com","QueryResult",0,1,true), com.sforce.soap.tooling.QueryResult.class));
      }
    }
    ...
    private void writeFieldFieldMappings(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("FieldMappings", "urn:sobject.tooling.soap.sforce.com","FieldMappings","urn:tooling.soap.sforce.com","QueryResult",0,1,true), FieldMappings, FieldMappings__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "FieldMapping");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldFieldMappingClient(__out, __typeMapper);
      writeFieldFieldMappingClientId(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setFieldMappingClient(__in, __typeMapper);
      setFieldMappingClientId(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "FieldMappingClient", FieldMappingClient);
      toStringHelper(sb, "FieldMappingClientId", FieldMappingClientId);
