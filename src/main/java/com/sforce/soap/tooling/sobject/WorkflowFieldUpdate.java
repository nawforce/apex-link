 ...
 */
public class WorkflowFieldUpdate extends com.sforce.soap.tooling.sobject.SObject {
    ...
    protected void setLiteralValue(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("LiteralValue", "urn:sobject.tooling.soap.sforce.com","LiteralValue","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setLiteralValue(__typeMapper.readString(__in, _lookupTypeInfo("LiteralValue", "urn:sobject.tooling.soap.sforce.com","LiteralValue","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldLiteralValue(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("LiteralValue", "urn:sobject.tooling.soap.sforce.com","LiteralValue","http://www.w3.org/2001/XMLSchema","string",0,1,true), LiteralValue, LiteralValue__is_set);
    }

    /**
     * element : LookupValueId of type {urn:tooling.soap.sforce.com}ID
     * java type: java.lang.String
     */
    private boolean LookupValueId__is_set = false;

    private java.lang.String LookupValueId;

    public java.lang.String getLookupValueId() {
      return LookupValueId;
    }

    public void setLookupValueId(java.lang.String LookupValueId) {
      this.LookupValueId = LookupValueId;
      LookupValueId__is_set = true;
    }

    protected void setLookupValueId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("LookupValueId", "urn:sobject.tooling.soap.sforce.com","LookupValueId","urn:tooling.soap.sforce.com","ID",0,1,true))) {
        setLookupValueId(__typeMapper.readString(__in, _lookupTypeInfo("LookupValueId", "urn:sobject.tooling.soap.sforce.com","LookupValueId","urn:tooling.soap.sforce.com","ID",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldLookupValueId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("LookupValueId", "urn:sobject.tooling.soap.sforce.com","LookupValueId","urn:tooling.soap.sforce.com","ID",0,1,true), LookupValueId, LookupValueId__is_set);
    }
    ...
    /**
     * element : Metadata of type {urn:metadata.tooling.soap.sforce.com}WorkflowFieldUpdate
     * java type: com.sforce.soap.tooling.metadata.WorkflowFieldUpdate
     */
    private boolean Metadata__is_set = false;

    private com.sforce.soap.tooling.metadata.WorkflowFieldUpdate Metadata;

    public com.sforce.soap.tooling.metadata.WorkflowFieldUpdate getMetadata() {
      return Metadata;
    }

    public void setMetadata(com.sforce.soap.tooling.metadata.WorkflowFieldUpdate Metadata) {
    ...
    protected void setMetadata(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","WorkflowFieldUpdate",0,1,true))) {
        setMetadata((com.sforce.soap.tooling.metadata.WorkflowFieldUpdate)__typeMapper.readObject(__in, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","WorkflowFieldUpdate",0,1,true), com.sforce.soap.tooling.metadata.WorkflowFieldUpdate.class));
      }
    }
    ...
    private void writeFieldMetadata(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("Metadata", "urn:sobject.tooling.soap.sforce.com","Metadata","urn:metadata.tooling.soap.sforce.com","WorkflowFieldUpdate",0,1,true), Metadata, Metadata__is_set);
    }
    ...
    /**
     * element : SourceTableEnumOrId of type {http://www.w3.org/2001/XMLSchema}string
     * java type: java.lang.String
     */
    private boolean SourceTableEnumOrId__is_set = false;

    private java.lang.String SourceTableEnumOrId;

    public java.lang.String getSourceTableEnumOrId() {
      return SourceTableEnumOrId;
    }

    public void setSourceTableEnumOrId(java.lang.String SourceTableEnumOrId) {
      this.SourceTableEnumOrId = SourceTableEnumOrId;
      SourceTableEnumOrId__is_set = true;
    }

    protected void setSourceTableEnumOrId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("SourceTableEnumOrId", "urn:sobject.tooling.soap.sforce.com","SourceTableEnumOrId","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setSourceTableEnumOrId(__typeMapper.readString(__in, _lookupTypeInfo("SourceTableEnumOrId", "urn:sobject.tooling.soap.sforce.com","SourceTableEnumOrId","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldSourceTableEnumOrId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("SourceTableEnumOrId", "urn:sobject.tooling.soap.sforce.com","SourceTableEnumOrId","http://www.w3.org/2001/XMLSchema","string",0,1,true), SourceTableEnumOrId, SourceTableEnumOrId__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:sobject.tooling.soap.sforce.com", "WorkflowFieldUpdate");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldLookupValueId(__out, __typeMapper);
      ...
      writeFieldSourceTableEnumOrId(__out, __typeMapper);
    }
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "LookupValueId", LookupValueId);
      ...
      toStringHelper(sb, "SourceTableEnumOrId", SourceTableEnumOrId);
    }
