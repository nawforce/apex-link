...
public class RelatedListColumn implements com.sforce.ws.bind.XMLizable {
    ...
    /**
     * element : fieldApiName of type {http://www.w3.org/2001/XMLSchema}string
     * java type: java.lang.String
     */
    private boolean fieldApiName__is_set = false;
    ...
    public void setFieldApiName(java.lang.String fieldApiName) {
      ...
      fieldApiName__is_set = true;
    }

    protected void setFieldApiName(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("fieldApiName", "urn:tooling.soap.sforce.com","fieldApiName","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setFieldApiName(__typeMapper.readString(__in, _lookupTypeInfo("fieldApiName", "urn:tooling.soap.sforce.com","fieldApiName","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }

    private void writeFieldFieldApiName(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("fieldApiName", "urn:tooling.soap.sforce.com","fieldApiName","http://www.w3.org/2001/XMLSchema","string",1,1,true), fieldApiName, fieldApiName__is_set);
    }
    ...
    protected void setFormat(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("format", "urn:tooling.soap.sforce.com","format","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setFormat(__typeMapper.readString(__in, _lookupTypeInfo("format", "urn:tooling.soap.sforce.com","format","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldFormat(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("format", "urn:tooling.soap.sforce.com","format","http://www.w3.org/2001/XMLSchema","string",1,1,true), format, format__is_set);
    }
    ...
    protected void setLookupId(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("lookupId", "urn:tooling.soap.sforce.com","lookupId","http://www.w3.org/2001/XMLSchema","string",0,1,true))) {
        setLookupId(__typeMapper.readString(__in, _lookupTypeInfo("lookupId", "urn:tooling.soap.sforce.com","lookupId","http://www.w3.org/2001/XMLSchema","string",0,1,true), java.lang.String.class));
      }
    }

    private void writeFieldLookupId(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("lookupId", "urn:tooling.soap.sforce.com","lookupId","http://www.w3.org/2001/XMLSchema","string",0,1,true), lookupId, lookupId__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldFieldApiName(__out, __typeMapper);
      writeFieldFormat(__out, __typeMapper);
      writeFieldLabel(__out, __typeMapper);
      writeFieldLookupId(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setFieldApiName(__in, __typeMapper);
      setFormat(__in, __typeMapper);
      setLabel(__in, __typeMapper);
      setLookupId(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "fieldApiName", fieldApiName);
      toStringHelper(sb, "format", format);
      toStringHelper(sb, "label", label);
      toStringHelper(sb, "lookupId", lookupId);
