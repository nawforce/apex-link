...
public class PackageVersion implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setMajorNumber(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("majorNumber", "urn:tooling.soap.sforce.com","majorNumber","http://www.w3.org/2001/XMLSchema","int",1,1,true))) {
        setMajorNumber((int)__typeMapper.readInt(__in, _lookupTypeInfo("majorNumber", "urn:tooling.soap.sforce.com","majorNumber","http://www.w3.org/2001/XMLSchema","int",1,1,true), int.class));
      }
    }
    ...
    private void writeFieldMajorNumber(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("majorNumber", "urn:tooling.soap.sforce.com","majorNumber","http://www.w3.org/2001/XMLSchema","int",1,1,true), majorNumber, majorNumber__is_set);
    }
    ...
    protected void setMinorNumber(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("minorNumber", "urn:tooling.soap.sforce.com","minorNumber","http://www.w3.org/2001/XMLSchema","int",1,1,true))) {
        setMinorNumber((int)__typeMapper.readInt(__in, _lookupTypeInfo("minorNumber", "urn:tooling.soap.sforce.com","minorNumber","http://www.w3.org/2001/XMLSchema","int",1,1,true), int.class));
      }
    }
    ...
    private void writeFieldMinorNumber(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("minorNumber", "urn:tooling.soap.sforce.com","minorNumber","http://www.w3.org/2001/XMLSchema","int",1,1,true), minorNumber, minorNumber__is_set);
    }
