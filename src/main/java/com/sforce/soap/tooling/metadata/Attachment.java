...
public class Attachment implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setContent(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("content", "urn:metadata.tooling.soap.sforce.com","content","http://www.w3.org/2001/XMLSchema","base64Binary",1,1,true))) {
        setContent((byte[])__typeMapper.readObject(__in, _lookupTypeInfo("content", "urn:metadata.tooling.soap.sforce.com","content","http://www.w3.org/2001/XMLSchema","base64Binary",1,1,true), byte[].class));
      }
    }
    ...
    private void writeFieldContent(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("content", "urn:metadata.tooling.soap.sforce.com","content","http://www.w3.org/2001/XMLSchema","base64Binary",1,1,true), content, content__is_set);
    }
