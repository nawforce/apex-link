 ...
 */
public class CspTrustedSite extends com.sforce.soap.tooling.metadata.Metadata {
    ...
    /**
     * element : context of type {urn:tooling.soap.sforce.com}CspTrustedSiteContext
     * java type: com.sforce.soap.tooling.CspTrustedSiteContext
     */
    private boolean context__is_set = false;

    private com.sforce.soap.tooling.CspTrustedSiteContext context;

    public com.sforce.soap.tooling.CspTrustedSiteContext getContext() {
      return context;
    }

    public void setContext(com.sforce.soap.tooling.CspTrustedSiteContext context) {
    ...
    protected void setContext(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("context", "urn:metadata.tooling.soap.sforce.com","context","urn:tooling.soap.sforce.com","CspTrustedSiteContext",0,1,true))) {
        setContext((com.sforce.soap.tooling.CspTrustedSiteContext)__typeMapper.readObject(__in, _lookupTypeInfo("context", "urn:metadata.tooling.soap.sforce.com","context","urn:tooling.soap.sforce.com","CspTrustedSiteContext",0,1,true), com.sforce.soap.tooling.CspTrustedSiteContext.class));
      }
    }
    ...
    private void writeFieldContext(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("context", "urn:metadata.tooling.soap.sforce.com","context","urn:tooling.soap.sforce.com","CspTrustedSiteContext",0,1,true), context, context__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:metadata.tooling.soap.sforce.com", "CspTrustedSite");
