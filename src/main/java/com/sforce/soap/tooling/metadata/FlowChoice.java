 ...
 */
public class FlowChoice extends com.sforce.soap.tooling.metadata.FlowElement {
    ...
    protected void setChoiceText(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("choiceText", "urn:metadata.tooling.soap.sforce.com","choiceText","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setChoiceText(__typeMapper.readString(__in, _lookupTypeInfo("choiceText", "urn:metadata.tooling.soap.sforce.com","choiceText","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }

    private void writeFieldChoiceText(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("choiceText", "urn:metadata.tooling.soap.sforce.com","choiceText","http://www.w3.org/2001/XMLSchema","string",1,1,true), choiceText, choiceText__is_set);
    }
    ...
    /**
     * element : userInput of type {urn:metadata.tooling.soap.sforce.com}FlowChoiceUserInput
     * java type: com.sforce.soap.tooling.metadata.FlowChoiceUserInput
     */
    private boolean userInput__is_set = false;

    private com.sforce.soap.tooling.metadata.FlowChoiceUserInput userInput;

    public com.sforce.soap.tooling.metadata.FlowChoiceUserInput getUserInput() {
      return userInput;
    }

    public void setUserInput(com.sforce.soap.tooling.metadata.FlowChoiceUserInput userInput) {
    ...
    protected void setUserInput(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("userInput", "urn:metadata.tooling.soap.sforce.com","userInput","urn:metadata.tooling.soap.sforce.com","FlowChoiceUserInput",0,1,true))) {
        setUserInput((com.sforce.soap.tooling.metadata.FlowChoiceUserInput)__typeMapper.readObject(__in, _lookupTypeInfo("userInput", "urn:metadata.tooling.soap.sforce.com","userInput","urn:metadata.tooling.soap.sforce.com","FlowChoiceUserInput",0,1,true), com.sforce.soap.tooling.metadata.FlowChoiceUserInput.class));
      }
    }

    private void writeFieldUserInput(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("userInput", "urn:metadata.tooling.soap.sforce.com","userInput","urn:metadata.tooling.soap.sforce.com","FlowChoiceUserInput",0,1,true), userInput, userInput__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:metadata.tooling.soap.sforce.com", "FlowChoice");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldChoiceText(__out, __typeMapper);
      writeFieldDataType(__out, __typeMapper);
      writeFieldUserInput(__out, __typeMapper);
      writeFieldValue(__out, __typeMapper);
    }

    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      setChoiceText(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "choiceText", choiceText);
      toStringHelper(sb, "dataType", dataType);
      toStringHelper(sb, "userInput", userInput);
