 ...
 */
public class FlowApexPluginCall extends com.sforce.soap.tooling.metadata.FlowNode {
    ...
    /**
     * element : inputParameters of type {urn:metadata.tooling.soap.sforce.com}FlowApexPluginCallInputParameter
     * java type: com.sforce.soap.tooling.metadata.FlowApexPluginCallInputParameter[]
     */
    private boolean inputParameters__is_set = false;

    private com.sforce.soap.tooling.metadata.FlowApexPluginCallInputParameter[] inputParameters = new com.sforce.soap.tooling.metadata.FlowApexPluginCallInputParameter[0];

    public com.sforce.soap.tooling.metadata.FlowApexPluginCallInputParameter[] getInputParameters() {
      return inputParameters;
    }

    public void setInputParameters(com.sforce.soap.tooling.metadata.FlowApexPluginCallInputParameter[] inputParameters) {
    ...
    protected void setInputParameters(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("inputParameters", "urn:metadata.tooling.soap.sforce.com","inputParameters","urn:metadata.tooling.soap.sforce.com","FlowApexPluginCallInputParameter",0,-1,true))) {
        setInputParameters((com.sforce.soap.tooling.metadata.FlowApexPluginCallInputParameter[])__typeMapper.readObject(__in, _lookupTypeInfo("inputParameters", "urn:metadata.tooling.soap.sforce.com","inputParameters","urn:metadata.tooling.soap.sforce.com","FlowApexPluginCallInputParameter",0,-1,true), com.sforce.soap.tooling.metadata.FlowApexPluginCallInputParameter[].class));
      }
    }
    ...
    private void writeFieldInputParameters(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("inputParameters", "urn:metadata.tooling.soap.sforce.com","inputParameters","urn:metadata.tooling.soap.sforce.com","FlowApexPluginCallInputParameter",0,-1,true), inputParameters, inputParameters__is_set);
    }

    /**
     * element : outputParameters of type {urn:metadata.tooling.soap.sforce.com}FlowApexPluginCallOutputParameter
     * java type: com.sforce.soap.tooling.metadata.FlowApexPluginCallOutputParameter[]
     */
    private boolean outputParameters__is_set = false;

    private com.sforce.soap.tooling.metadata.FlowApexPluginCallOutputParameter[] outputParameters = new com.sforce.soap.tooling.metadata.FlowApexPluginCallOutputParameter[0];

    public com.sforce.soap.tooling.metadata.FlowApexPluginCallOutputParameter[] getOutputParameters() {
      return outputParameters;
    }

    public void setOutputParameters(com.sforce.soap.tooling.metadata.FlowApexPluginCallOutputParameter[] outputParameters) {
    ...
    protected void setOutputParameters(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("outputParameters", "urn:metadata.tooling.soap.sforce.com","outputParameters","urn:metadata.tooling.soap.sforce.com","FlowApexPluginCallOutputParameter",0,-1,true))) {
        setOutputParameters((com.sforce.soap.tooling.metadata.FlowApexPluginCallOutputParameter[])__typeMapper.readObject(__in, _lookupTypeInfo("outputParameters", "urn:metadata.tooling.soap.sforce.com","outputParameters","urn:metadata.tooling.soap.sforce.com","FlowApexPluginCallOutputParameter",0,-1,true), com.sforce.soap.tooling.metadata.FlowApexPluginCallOutputParameter[].class));
      }
    }
    ...
    private void writeFieldOutputParameters(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("outputParameters", "urn:metadata.tooling.soap.sforce.com","outputParameters","urn:metadata.tooling.soap.sforce.com","FlowApexPluginCallOutputParameter",0,-1,true), outputParameters, outputParameters__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:metadata.tooling.soap.sforce.com", "FlowApexPluginCall");
