 ...
 */
public class RemoteSiteSetting extends com.sforce.soap.tooling.metadata.Metadata {
    ...
    protected void setDisableProtocolSecurity(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("disableProtocolSecurity", "urn:metadata.tooling.soap.sforce.com","disableProtocolSecurity","http://www.w3.org/2001/XMLSchema","boolean",1,1,true))) {
        setDisableProtocolSecurity(__typeMapper.readBoolean(__in, _lookupTypeInfo("disableProtocolSecurity", "urn:metadata.tooling.soap.sforce.com","disableProtocolSecurity","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), boolean.class));
      }
    }

    private void writeFieldDisableProtocolSecurity(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("disableProtocolSecurity", "urn:metadata.tooling.soap.sforce.com","disableProtocolSecurity","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), disableProtocolSecurity, disableProtocolSecurity__is_set);
    }
    ...
    protected void setUrl(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("url", "urn:metadata.tooling.soap.sforce.com","url","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setUrl(__typeMapper.readString(__in, _lookupTypeInfo("url", "urn:metadata.tooling.soap.sforce.com","url","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldUrl(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("url", "urn:metadata.tooling.soap.sforce.com","url","http://www.w3.org/2001/XMLSchema","string",1,1,true), url, url__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:metadata.tooling.soap.sforce.com", "RemoteSiteSetting");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldDisableProtocolSecurity(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setDisableProtocolSecurity(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "disableProtocolSecurity", disableProtocolSecurity);
