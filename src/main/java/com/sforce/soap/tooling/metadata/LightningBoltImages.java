 ...
 */
public class LightningBoltImages implements com.sforce.ws.bind.XMLizable {

    /**
     * Constructor
     */
    public LightningBoltImages() {}
    ...
    protected void setImage(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("image", "urn:metadata.tooling.soap.sforce.com","image","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setImage(__typeMapper.readString(__in, _lookupTypeInfo("image", "urn:metadata.tooling.soap.sforce.com","image","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldImage(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("image", "urn:metadata.tooling.soap.sforce.com","image","http://www.w3.org/2001/XMLSchema","string",1,1,true), image, image__is_set);
    }
