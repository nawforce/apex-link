 ...
 */
public class AccessControlPolicy extends com.sforce.soap.tooling.metadata.Metadata {
    ...
    /**
     * element : deploymentStatus of type {urn:tooling.soap.sforce.com}ACPStatus
     * java type: com.sforce.soap.tooling.ACPStatus
     */
    private boolean deploymentStatus__is_set = false;

    private com.sforce.soap.tooling.ACPStatus deploymentStatus;

    public com.sforce.soap.tooling.ACPStatus getDeploymentStatus() {
      return deploymentStatus;
    }

    public void setDeploymentStatus(com.sforce.soap.tooling.ACPStatus deploymentStatus) {
    ...
    protected void setDeploymentStatus(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("deploymentStatus", "urn:metadata.tooling.soap.sforce.com","deploymentStatus","urn:tooling.soap.sforce.com","ACPStatus",1,1,true))) {
        setDeploymentStatus((com.sforce.soap.tooling.ACPStatus)__typeMapper.readObject(__in, _lookupTypeInfo("deploymentStatus", "urn:metadata.tooling.soap.sforce.com","deploymentStatus","urn:tooling.soap.sforce.com","ACPStatus",1,1,true), com.sforce.soap.tooling.ACPStatus.class));
      }
    }
    ...
    private void writeFieldDeploymentStatus(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("deploymentStatus", "urn:metadata.tooling.soap.sforce.com","deploymentStatus","urn:tooling.soap.sforce.com","ACPStatus",1,1,true), deploymentStatus, deploymentStatus__is_set);
    }
    ...
    /**
     * element : targetEntity of type {http://www.w3.org/2001/XMLSchema}string
     * java type: java.lang.String
     */
    ...
    public void setTargetEntity(java.lang.String targetEntity) {
      ...
      targetEntity__is_set = true;
    }

    protected void setTargetEntity(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("targetEntity", "urn:metadata.tooling.soap.sforce.com","targetEntity","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setTargetEntity(__typeMapper.readString(__in, _lookupTypeInfo("targetEntity", "urn:metadata.tooling.soap.sforce.com","targetEntity","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }

    private void writeFieldTargetEntity(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("targetEntity", "urn:metadata.tooling.soap.sforce.com","targetEntity","http://www.w3.org/2001/XMLSchema","string",1,1,true), targetEntity, targetEntity__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:metadata.tooling.soap.sforce.com", "AccessControlPolicy");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldTargetEntity(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
      ...
      setTargetEntity(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      ...
      toStringHelper(sb, "targetEntity", targetEntity);
