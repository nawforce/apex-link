 ...
 */
public class GlobalValueSet extends com.sforce.soap.tooling.metadata.Metadata {
    ...
    /**
     * element : customValue of type {urn:metadata.tooling.soap.sforce.com}CustomValue
     * java type: com.sforce.soap.tooling.metadata.CustomValue[]
     */
    private boolean customValue__is_set = false;

    private com.sforce.soap.tooling.metadata.CustomValue[] customValue = new com.sforce.soap.tooling.metadata.CustomValue[0];

    public com.sforce.soap.tooling.metadata.CustomValue[] getCustomValue() {
      return customValue;
    }

    public void setCustomValue(com.sforce.soap.tooling.metadata.CustomValue[] customValue) {
      this.customValue = customValue;
      customValue__is_set = true;
    }

    protected void setCustomValue(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.isElement(__in, _lookupTypeInfo("customValue", "urn:metadata.tooling.soap.sforce.com","customValue","urn:metadata.tooling.soap.sforce.com","CustomValue",0,-1,true))) {
        setCustomValue((com.sforce.soap.tooling.metadata.CustomValue[])__typeMapper.readObject(__in, _lookupTypeInfo("customValue", "urn:metadata.tooling.soap.sforce.com","customValue","urn:metadata.tooling.soap.sforce.com","CustomValue",0,-1,true), com.sforce.soap.tooling.metadata.CustomValue[].class));
      }
    }

    private void writeFieldCustomValue(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("customValue", "urn:metadata.tooling.soap.sforce.com","customValue","urn:metadata.tooling.soap.sforce.com","CustomValue",0,-1,true), customValue, customValue__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:metadata.tooling.soap.sforce.com", "GlobalValueSet");
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldCustomValue(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      setCustomValue(__in, __typeMapper);
    ...
    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "customValue", customValue);
