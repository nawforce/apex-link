...
public class KnowledgeSitesSettings implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setSite(com.sforce.ws.parser.XmlInputStream __in,
      ...
      if (__typeMapper.isElement(__in, _lookupTypeInfo("site", "urn:metadata.tooling.soap.sforce.com","site","http://www.w3.org/2001/XMLSchema","string",0,-1,true))) {
        setSite((java.lang.String[])__typeMapper.readObject(__in, _lookupTypeInfo("site", "urn:metadata.tooling.soap.sforce.com","site","http://www.w3.org/2001/XMLSchema","string",0,-1,true), java.lang.String[].class));
      }
    }
