 ...
 */
public class ConversationVariable implements com.sforce.ws.bind.XMLizable {

    /**
     * Constructor
     */
    public ConversationVariable() {}
    ...
    /**
     * element : dataType of type {urn:tooling.soap.sforce.com}ConversationDataType
     * java type: com.sforce.soap.tooling.ConversationDataType
     */
    private boolean dataType__is_set = false;

    private com.sforce.soap.tooling.ConversationDataType dataType;

    public com.sforce.soap.tooling.ConversationDataType getDataType() {
      return dataType;
    }

    public void setDataType(com.sforce.soap.tooling.ConversationDataType dataType) {
    ...
    protected void setDataType(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("dataType", "urn:metadata.tooling.soap.sforce.com","dataType","urn:tooling.soap.sforce.com","ConversationDataType",1,1,true))) {
        setDataType((com.sforce.soap.tooling.ConversationDataType)__typeMapper.readObject(__in, _lookupTypeInfo("dataType", "urn:metadata.tooling.soap.sforce.com","dataType","urn:tooling.soap.sforce.com","ConversationDataType",1,1,true), com.sforce.soap.tooling.ConversationDataType.class));
      }
    }
    ...
    private void writeFieldDataType(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("dataType", "urn:metadata.tooling.soap.sforce.com","dataType","urn:tooling.soap.sforce.com","ConversationDataType",1,1,true), dataType, dataType__is_set);
    }
    ...
    public String toString() {
      ...
      sb.append("[ConversationVariable ");
      toString1(sb);
