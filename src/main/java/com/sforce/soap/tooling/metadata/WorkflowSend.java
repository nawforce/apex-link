 ...
 */
public class WorkflowSend extends com.sforce.soap.tooling.metadata.WorkflowAction {
    ...
    /**
     * element : action of type {urn:tooling.soap.sforce.com}SendAction
     * java type: com.sforce.soap.tooling.SendAction
     */
    private boolean action__is_set = false;

    private com.sforce.soap.tooling.SendAction action;

    public com.sforce.soap.tooling.SendAction getAction() {
      return action;
    }

    public void setAction(com.sforce.soap.tooling.SendAction action) {
      this.action = action;
      action__is_set = true;
    }
    ...
    protected void setAction(com.sforce.ws.parser.XmlInputStream __in,
      ...
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("action", "urn:metadata.tooling.soap.sforce.com","action","urn:tooling.soap.sforce.com","SendAction",1,1,true))) {
        setAction((com.sforce.soap.tooling.SendAction)__typeMapper.readObject(__in, _lookupTypeInfo("action", "urn:metadata.tooling.soap.sforce.com","action","urn:tooling.soap.sforce.com","SendAction",1,1,true), com.sforce.soap.tooling.SendAction.class));
      }
    }
    ...
    private void writeFieldAction(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("action", "urn:metadata.tooling.soap.sforce.com","action","urn:tooling.soap.sforce.com","SendAction",1,1,true), action, action__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:metadata.tooling.soap.sforce.com", "WorkflowSend");
