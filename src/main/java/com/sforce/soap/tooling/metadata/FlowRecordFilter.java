 ...
 */
public class FlowRecordFilter extends com.sforce.soap.tooling.metadata.FlowBaseElement {
    ...
    /**
     * element : operator of type {urn:tooling.soap.sforce.com}FlowRecordFilterOperator
     * java type: com.sforce.soap.tooling.FlowRecordFilterOperator
     */
    private boolean operator__is_set = false;

    private com.sforce.soap.tooling.FlowRecordFilterOperator operator;

    public com.sforce.soap.tooling.FlowRecordFilterOperator getOperator() {
      return operator;
    }

    public void setOperator(com.sforce.soap.tooling.FlowRecordFilterOperator operator) {
    ...
    protected void setOperator(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("operator", "urn:metadata.tooling.soap.sforce.com","operator","urn:tooling.soap.sforce.com","FlowRecordFilterOperator",1,1,true))) {
        setOperator((com.sforce.soap.tooling.FlowRecordFilterOperator)__typeMapper.readObject(__in, _lookupTypeInfo("operator", "urn:metadata.tooling.soap.sforce.com","operator","urn:tooling.soap.sforce.com","FlowRecordFilterOperator",1,1,true), com.sforce.soap.tooling.FlowRecordFilterOperator.class));
      }
    }
    ...
    private void writeFieldOperator(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("operator", "urn:metadata.tooling.soap.sforce.com","operator","urn:tooling.soap.sforce.com","FlowRecordFilterOperator",1,1,true), operator, operator__is_set);
    }
    ...
    public void write(javax.xml.namespace.QName __element,
      ...
      __typeMapper.writeXsiType(__out, "urn:metadata.tooling.soap.sforce.com", "FlowRecordFilter");
