...
public class RelatedList implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setHideOnDetail(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("hideOnDetail", "urn:metadata.tooling.soap.sforce.com","hideOnDetail","http://www.w3.org/2001/XMLSchema","boolean",1,1,true))) {
        setHideOnDetail(__typeMapper.readBoolean(__in, _lookupTypeInfo("hideOnDetail", "urn:metadata.tooling.soap.sforce.com","hideOnDetail","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), boolean.class));
      }
    }

    private void writeFieldHideOnDetail(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("hideOnDetail", "urn:metadata.tooling.soap.sforce.com","hideOnDetail","http://www.w3.org/2001/XMLSchema","boolean",1,1,true), hideOnDetail, hideOnDetail__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldHideOnDetail(__out, __typeMapper);
      writeFieldName(__out, __typeMapper);
    }

    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      setHideOnDetail(__in, __typeMapper);
      setName(__in, __typeMapper);
    }

    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "hideOnDetail", hideOnDetail);
