 ...
 */
public class ProfileExternalDataSourceAccess implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setExternalDataSource(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("externalDataSource", "urn:metadata.tooling.soap.sforce.com","externalDataSource","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setExternalDataSource(__typeMapper.readString(__in, _lookupTypeInfo("externalDataSource", "urn:metadata.tooling.soap.sforce.com","externalDataSource","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldExternalDataSource(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("externalDataSource", "urn:metadata.tooling.soap.sforce.com","externalDataSource","http://www.w3.org/2001/XMLSchema","string",1,1,true), externalDataSource, externalDataSource__is_set);
    }
    ...
    public String toString() {
      ...
      sb.append("[ProfileExternalDataSourceAccess ");
      toString1(sb);
