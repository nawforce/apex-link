...
public class Login_element implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setPassword(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("password", "urn:tooling.soap.sforce.com","password","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setPassword(__typeMapper.readString(__in, _lookupTypeInfo("password", "urn:tooling.soap.sforce.com","password","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }
    ...
    private void writeFieldPassword(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("password", "urn:tooling.soap.sforce.com","password","http://www.w3.org/2001/XMLSchema","string",1,1,true), password, password__is_set);
    }
