...
public class Retrieve_element implements com.sforce.ws.bind.XMLizable {
    ...
    protected void setSelect(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      __in.peekTag();
      if (__typeMapper.verifyElement(__in, _lookupTypeInfo("select", "urn:tooling.soap.sforce.com","select","http://www.w3.org/2001/XMLSchema","string",1,1,true))) {
        setSelect(__typeMapper.readString(__in, _lookupTypeInfo("select", "urn:tooling.soap.sforce.com","select","http://www.w3.org/2001/XMLSchema","string",1,1,true), java.lang.String.class));
      }
    }

    private void writeFieldSelect(com.sforce.ws.parser.XmlOutputStream __out, com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException {
      __typeMapper.writeObject(__out, _lookupTypeInfo("select", "urn:tooling.soap.sforce.com","select","http://www.w3.org/2001/XMLSchema","string",1,1,true), select, select__is_set);
    }
    ...
    private void writeFields1(com.sforce.ws.parser.XmlOutputStream __out,
      ...
      writeFieldSelect(__out, __typeMapper);
    ...
    private void loadFields1(com.sforce.ws.parser.XmlInputStream __in,
        com.sforce.ws.bind.TypeMapper __typeMapper) throws java.io.IOException, com.sforce.ws.ConnectionException {
      setSelect(__in, __typeMapper);
      setType(__in, __typeMapper);
      setIds(__in, __typeMapper);
    }

    private void toString1(StringBuilder sb) {
      toStringHelper(sb, "select", select);
